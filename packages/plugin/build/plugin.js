...
exports.resourceId = exports.method = exports.getPendingResourceReferences = exports.getResourceReferences = exports.isResourceReference = exports.ProjectFile = exports.PROJECT_FILE_NAME = exports.FRAMEWORK_FOLDER = void 0;
var path_1 = __importDefault(require("path"));
var zod_inquirer_1 = require("@fx/zod-inquirer");
var file_1 = require("@nice/file");
    ...
    return inputShape
        ? __assign({ inputs: function (context) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                answers = _b.sent();
                                return [2 /*return*/, inputTransform
                                        ? inputTransform(answers, context)
                                        : answers];
                        }
                    });
                });
            ...
            return inputTransform
                ? inputTransform === null || inputTransform === void 0 ? void 0 : inputTransform(__assign({}, context === null || context === void 0 ? void 0 : context.defaults), context)
