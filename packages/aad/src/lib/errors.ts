...
const isMultiEnvEnabled = true; // TODO: remove
...
export const GetSkipAppConfigError: AadError = {
  ...
  message: (fileName: string) =>
    ...
    `${
      ...
      isMultiEnvEnabled ? Plugins.auth : Plugins.pluginNameComplex
    } in ${fileName}.`,
  helpLink: aadHelpLink,
};
...
export const UpdateRedirectUriError: AadError = {
  ...
  message: () =>
    `Failed to update application redirect URI in Azure Active Directory.`,
};

export const UpdateAppIdUriError: AadError = {
  name: "UpdateAppIdUriError",
  message: () =>
    `Failed to update Application ID URI in Azure Active Directory. ${referHelpLink}`,
  helpLink: aadHelpLink,
};
...
export const UpdatePermissionError: AadError = {
  ...
  message: () =>
    `Failed to update application permission in Azure Active Directory.`,
};
...
export const UnknownPermissionName: AadError = {
  ...
  message: (name: string) =>
    `Failed to find resource: ${name}. ${referHelpLink}`,
  helpLink: aadHelpLink,
};
...
export const GrantPermissionError: AadError = {
  ...
  message: (resource: string, id: string) =>
    `${resource}: ${id}. Failed to grant permission.`,
};
...
export class GraphClientErrorMessage {
  ...
  static readonly GetFailed =
    "Failed to retrieve Azure Active Directory application registration.";
  static readonly CheckPermissionFailed =
    "Failed to check permission in Azure Active Directory.";
  static readonly GrantPermissionFailed =
    "Failed to grant permission in Azure Active Directory.";
