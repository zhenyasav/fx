...
exports.relative = exports.kib = exports.ellipsis = exports.fileExists = void 0;
...
var kib = function (bytes) {
    return bytes < 1024 ? "".concat(bytes, " B") : "".concat(Math.round(bytes / 1024), " KiB");
};
exports.kib = kib;
function relative(s) {
